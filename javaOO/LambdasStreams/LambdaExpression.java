...
public class LambdaExpression {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//.skip(2)
		//.limit(2) //Limita o resultado a ser exibido, no exemplo, até 02 alunos
		.filter(pessoa -> pessoa.equals("Tecazoide")) //Predicate > usa uma função com teste lógico que retorna um Optional
		...
		.orElse("Infelizmente não consegui localizar a pessoa informada.");
		...
		//	.forEach(System.out::println);
			.reduce((acumulador, number) -> acumulador+=number)//Recebe dois parâmetros, Binary Operation, o acumulador e outro parâmetro
