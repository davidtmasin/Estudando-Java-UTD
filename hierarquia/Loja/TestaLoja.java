...
public class TestaLoja {
	public static void main(String [] args) {
		...
		Livro livro2 = new Livro(666, "A permissão digital", 65.85, "Titio Mark");
		...
		*/
		...
		System.out.println("Pendrives ordenados do menor preço para o maior");
		System.out.println("-----------------------------------------");
		...
		System.out.println("Livros ordenados do menor preço para o maior");
		System.out.println("-----------------------------------------");
